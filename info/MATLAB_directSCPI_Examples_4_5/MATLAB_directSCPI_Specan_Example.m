...
%-----------------------------------------------------------
try
    specan = VISA_Instrument('TCPIP::localhost::INSTR'); % Adjust the VISA Resource string to fit your instrument
...
try
    ...
    tic
    traceASC = specan.QueryASCII_ListOfDoubles('FORM ASC;:TRAC? TRACE1', sweepPoints); % sweepPoints is the maximum possible allowed count to read
    toc
