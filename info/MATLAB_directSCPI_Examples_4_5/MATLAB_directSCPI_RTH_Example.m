...
% Make sure you have VISA_Instrument.m component of version 1.6.0 or later
...
%-----------------------------------------------------------
try
    rth = VISA_Instrument('TCPIP::10.64.0.146::INSTR'); % Adjust the VISA Resource string to fit your RTH instrument
