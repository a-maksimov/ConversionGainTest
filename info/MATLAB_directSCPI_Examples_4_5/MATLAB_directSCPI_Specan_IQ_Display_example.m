...
% Make sure you have installed NI VISA 15.0 or newer with its .NET support component
%
% This example configures the spectrum analyzer to capture IQ data. 
...
try
    ...
    specan.QueryString('INST:CRE:NEW IQ, ''IQ Analyzer'';*OPC?'); % Open IQ Analyzer
